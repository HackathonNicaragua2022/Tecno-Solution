...
Public Class Conexion_Pc_Secundaria
    Dim utilidades As New Utilidades
    Private Sub Conexion_Pc_Secundaria_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Sub conectar_manualmente()
        ...
        cadena_de_conexion = "Data Source =" & IP & ";Initial Catalog=Ctrl_Estudiantil;Integrated Security=False; User Id=jess92;Password=softwarereal"
        mostrar_conexion()
        If indicador_de_conexion = "HAY CONEXION" Then
            utilidades.Guardar_Conexion("Ctrl_Estudiantil.My.MySettings.Cn", cadena_de_conexion)
            utilidades.Guardar_Conexion("Ctrl_Estudiantil.My.MySettings.Francisca_Hernandez_EConnectionString", cadena_de_conexion)
            ...
            If datalistado_movimientos_validar.RowCount > 0 Then
                ...
                MessageBox.Show("Conexión Correcta. El sistema se reiniciara", "Conexión Exitosa", MessageBoxButtons.OK, MessageBoxIcon.Information)
                Application.Restart()
    ...
    Sub mostrar_conexion()
        ...
        Try
            Dim conexionManual As New SqlConnection(cadena_de_conexion)
            conexionManual.Open()
            da = New SqlDataAdapter("select * from Docentes", conexionManual)
            da.Fill(dt)
    ...
    Public Sub SavetoXML(ByVal dbcnString)
        ...
        writer.Close()
    End Sub
    Public Sub SavetoXML_Servidor_Remoto()
        'Dim doc As XmlDocument = New XmlDocument()
        'doc.Load("Servidor_Remoto.xml")
        'Dim root As XmlElement = doc.DocumentElement
        'root.Attributes.Item(0).Value = "Cliente"
    ...
    Sub mostrar_usuario()
        ...
        Try
            ...
            da = New SqlDataAdapter("select * from Docentes", cadena_de_conexion)
            da.Fill(dt)
            datalistado_movimientos_validar.DataSource = dt
